...
class AnthropicActor:
    ...
    def __call__(self, *, messages: list[BetaMessageParam]):
        ...
        # Use project logger for debug output
        from web_agent.util.logger import log_debug

        log_debug(f"AnthropicActor response: {response}")
        ...
        if self.print_usage:
            # Use project logger for user-visible info
            from web_agent.util.logger import log_info
